...
module.exports = "<form (submit)=\"submit()\">\n  <input type=\"text\" #nombre>\n\n  <input type=\"text\" #cc>\n\n\n  <button type=\"button\" name=\"button\" (click)=\"descargarPDF(nombre,cc)\">DescargarPDF</button>\n</form>\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.descargarPDF = function (nombre, cc) {
        var fecha = new Date();
            ...
            content: [
                {
                    pageSize: 'letter',
                    //Fecha
                    text: fecha.getDay() + " / " + fecha.getMonth() + " / " + fecha.getFullYear() + "\n\n\n\n\n", alignment: 'right'
                },
                {
                    //Titulo
                ...
                },
                {
                    ...
                    text: [
                        ...
                        { text: "" + this.nombre, fontSize: 15, bold: true },
                        ...
                        { text: "" + this.cc, fontSize: 15, bold: true },
        ...
        // pdfMake.createPdf(dd).download('demanda.pdf');
        pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_2__["createPdf"](dd).open();
    };
...
module.exports = __webpack_require__(/*! C:\Users\anafe9\documents\jonathan\programacion\jspdf-Angular\angular-pdf\src\main.ts */"./src/main.ts");
